...
!!! note "ゲームの特徴"
    `[PvP参加]` 看板を右クリックして待機キューに並び、2人そろったら `[PvP開始]` 看板（またはOPの `/pvp start`）で試合が始まります。参加にはバトルパスランクに応じたエメラルドの入場料が必要で、勝者には賞金とランクアップが与えられます。観戦者は `[PvP賭け]` 看板を右クリックして賭けGUIを開き、選手にエメラルドを賭けて的中すればランク差に応じた配当を獲得できます。
