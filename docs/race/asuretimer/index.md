...
!!! info "プラグインについて"
    AsureTimer は単独のプラグイン（jar）です。`plugins/` フォルダに jar を入れる通常の手順で導入できます。看板による計測開始・ゴール、感圧板チェックポイント、SQLite によるランキング保存に対応しています。
...
- **プレイヤー向け** … コースの走り方、タイム計測の開始とゴール、看板からの参加、ランキングの見方、コマンド、FAQ。
- **OP・運営向け** … 導入手順、config.yml、コース・看板のセットアップ、権限、管理コマンド。
