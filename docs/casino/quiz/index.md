...
毎日5問の **デイリークイズ** と、全100階の **クイズタワー** に挑戦できるクイズゲームです。問題に正解するとエメラルドがもらえ、正解率・到達階のランキングも競えます。CasinoPlugin に含まれる **quiz モジュール** として動作します。

<div class="quick-grid">
  <div class="quick-card"><span class="label">カテゴリ</span><span class="value">❓ クイズ・知識ゲーム</span></div>
  <div class="quick-card"><span class="label">モード</span><span class="value">デイリークイズ／クイズタワー</span></div>
...
- **プレイヤー向け** … デイリークイズ・クイズタワーの遊び方、ランキング、報酬、コマンド、FAQ。
- **OP・運営向け** … 有効化、quiz.yml の設定、問題の追加方法、NPC・看板の設置、権限・管理コマンド。
